...
#create counters for properties by state, category, and area of significance
with open("/Users/juliecarlson/Desktop/628 Final Project/results/2021-11-01_National-Register-Processed-Dataset.csv", "r") as originalcsvfile:
    ...
    for row in reader:
        ...
        if row['year'] != '':
            if row['year'] not in count_by_year_listed:
                count_by_year_listed[row['year']]=0
            count_by_year_listed[row['year']]=count_by_year_listed[row['year']]+1
